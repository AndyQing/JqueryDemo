	...
	$.fn.datetimepicker = function (opt, opt2) {
		...
		createDateTimePicker = function (input) {
			var datetimepicker = $('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
				...
				month_picker = $('<div class="xdsoft_monthpicker"><img type="button" class="xdsoft_prev today_prev" src="./screen/left.png" alt=""></img>' +
				'<div class="xdsoft_label xdsoft_month"><span></span><i></i></div>' +
					'<div class="xdsoft_label xdsoft_year"><span></span><i></i></div>' +
					'<img type="button" class="xdsoft_next today_prev" src="./screen/right.png" alt=""></img></div>'),
				calendar = $('<div class="xdsoft_calendar"></div>'),
				returnToday = $('<div><div class="return-today"><img type="button" src="./screen/return.png" alt="" class="xdsoft_today_button today_img"></img>今天</div>'),
				timepicker = $('<div class="xdsoft_timepicker active"><img type="button" class="xdsoft_prev today_next" src="./screen/up.png" alt=""></img><div class="xdsoft_time_box"></div><img type="button" class="xdsoft_next today_next" src="./screen/down.png" alt=""></img></div></div>'),
			...
			datetimepicker.setOptions = function (_options) {
				...
				console.log('month_picker',returnToday);
